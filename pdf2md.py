# Convert PDF documents to Markdown in preparation for the ingestion into the
# vector database.
# Marcelo Garcia
# Adapted from the 'docling' documentation.
# Oct/2025.
#==============================================================================
...
def main():
    ...
    # your own files.
    data_folder = Path("/") / "data" / "ETD_rag" 
    etd_folder = data_folder / "test"
    input_doc_paths = [ ff for ff in etd_folder.iterdir() ]
    ...
    _success_count, _partial_success_count, failure_count = export_documents(
        conv_results, output_dir=Path("/data/ETD_rag/markdown")
    )
